...
echo '<h2>How do we deal with arrays??? First we will use indexed arrays</h2>';
...
echo '<h2>Our Nav created with a function!</h2>';
echo make_links($nav);
...
<p>If post wines is not empty, take post wines and implode them.
